...
class control extends adminbase {
	...
	function onping() {
		...
		if($status == '1') {
			...
			echo 'document.getElementById(\'status_'.$appid.'\').innerHTML = "<img src=\'images/error.gif\' border=\'0\' class=\'statimg\' \/><span class=\'red\'>'.$this->lang['app_connent_false'].$url.'</span>";testlink();';
		}
